...
export const ESTADOS: EstadoDef[] = [
  ...
  { id: 'pieza_pedida_movil', label: 'Pieza pedida - Movil en tienda', flujo: 'pieza', fase: 'pedido', avisado: false, movil_en_tienda: true, color: '#F3CB63', siguientes: ['reparar', 'cancelado', 'finalizado'] },
